        ...
        <div className="p-10 my-20 mx-5 bg-gray-200">
            ...
            <div className="md:grid grid-cols-2 mt-10 w-full">
                <div className="px-3">
                    ...
                    <div className="mb-3">
                        <textarea value={bookDetails.abstract} onChange={e=>setBookDetails({...bookDetails,abstract:e.target.value})} type="text" placeholder='Book Abstract' className="p-2 bg-white w-full rounded" />
                    </div>
                </div>
                <div className="px-3">
                    <div className="mb-3">
                    ...
                    <div className='mb-3 flex justify-center items-center'>
                        ...
                        <img width={'200px'} src={preview?preview:"https://cdn.pixabay.com/photo/2017/06/13/12/53/upload-2398772_640.png"} alt="upload" />
                        </label>
                            ...
                            <div className='flex justify-center items-center'>
                                    {/* uploading images */}
                                    {
                                        previewList?.map((bookImgURL,index)=>(
                                            <img width={'70px'} height={'70px'} className='mx-3' src={bookImgURL} alt="upload book" />
                                        ))
                                    }
            ...
            <div className="flex justify-center">
                ...
                <button onClick={handleUploadBook} className='bg-blue-400 text-white p-2 rounded me-5 hover:bg-white hover:text-blue-400'>ADD BOOK</button>
            </div>
        </div>
        {/* toast */}
              <ToastContainer
